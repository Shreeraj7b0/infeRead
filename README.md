...
Listen to your books hands-free. The integrated Text-to-Speech engine parses your EPUB documents at sentence boundaries to deliver natural pacing. Supports multi-language narration, currently limited to English (with multiple regional accents), Hindi, and Marathi.
### PDF to EPUB Conversion
Convert standard PDF documents into fluid, reflowable EPUB ebooks directly on your device, making it easier to read on smaller screens with full font customization.
### Online Ebook Sourcing
Browse, search, and download public domain ebooks and publications directly inside the app using built-in integration with online catalogs like Project Gutenberg, Anna's Archive, and Internet Archive. With the system-wide Offline Mode toggle, you can instantly turn off all external network calls and restrict the application to strictly local operations.
...
### Deep Search
Locate content instantly across your entire library. The search engine scans not only book titles and authors, but also bookshelf names, checklist contents, and the full-text body of text documents.
### Reading Statistics
...
### Data Export
Take control of your reading history. infeRead allows you to export your full application data in a portable format for backup or external storage. In addition to a full system export, you can perform individual exports for checklists, specific file formats, bookshelves, and reading lists, ensuring your data is always accessible and easily migratable.
