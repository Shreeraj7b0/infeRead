...
@Database(entities = [User::class, LibraryFile::class, Checklist::class, ChecklistItem::class, ReadingSession::class, Annotation::class, Bookshelf::class, BookshelfItem::class], version = 9, exportSchema = false)
