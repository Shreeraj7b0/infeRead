...
fun HomeScreen(
    ...
    androidx.activity.compose.BackHandler(enabled = drawerState.isOpen || searchExpanded || activeChecklistId != null || activeNavTab == "online") {
        if (drawerState.isOpen) {
            ...
            searchQuery = ""; viewModel.setSearchQuery("")
            ...
            Box(
                ...
                if (activeNavTab == "online") {
                    ...
                    if (activeChecklist != null) {
                        ...
                        val canUndo by viewModel.canUndoChecklistAction.collectAsState()
                        ...
                        Column(
                            ...
                            Row(
                                ...
                                // Undo button
                                IconButton(
                                    onClick = { viewModel.undoLastChecklistAction() },
                                    enabled = canUndo
                                ) {
                                    Icon(
                                        Icons.AutoMirrored.Filled.Undo,
                                        contentDescription = "Undo",
                                        tint = if (canUndo) MaterialTheme.colorScheme.primary else MaterialTheme.colorScheme.onBackground.copy(alpha = 0.3f)
                                    )
                                }
                                Box {
                                        ...
                                        when (result) {
                                            ...
                                            is Checklist -> {
                                                Row(
                                                    ...
                                                    Icon(Icons.AutoMirrored.Filled.List, contentDescription = null, tint = MaterialTheme.colorScheme.secondary, modifier = Modifier.size(24.dp))
                                                    Spacer(Modifier.width(12.dp))
